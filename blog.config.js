...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'nitama.de', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不惑X', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lnk.bio/jaylenng', // 网站地址
